...
const PizzaPromo = () => {
  ...
  const handleQuickAdd = (e) => {
    ...
    addToCart({
      ...
      price: "$15.95",
      numPrice: 15.95,
      img: "https://images.unsplash.com/photo-1616141215340-34b0e7c661c8?q=80&w=600&auto=format&fit=crop",
    ...
    alert("🎉 Ultimate Double Cheese Pizza added to your bag!");
  };
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-200/80 grid grid-cols-1 lg:grid-cols-12 items-stretch">
          ...
          <div className="lg:col-span-6 p-8 sm:p-12 md:p-16 flex flex-col justify-between order-1 lg:order-1">
            ...
            <div>
              ...
              <p className="text-gray-600 text-base sm:text-lg font-normal leading-relaxed mb-8">
                A wood-fired crust loaded with a blend of mozzarella, provolone, and cheddar — pulled fresh for that legendary cheese-stretch in every single slice.
              </p>
          ...
          <div className="lg:col-span-6 relative min-h-[350px] sm:min-h-[450px] lg:min-h-[550px] overflow-hidden bg-gray-900 group order-2 lg:order-2">
            <img
              src="https://images.unsplash.com/photo-1616141215340-34b0e7c661c8?q=80&w=600&auto=format&fit=crop"
              alt="Ultimate Double Cheese Pizza"
